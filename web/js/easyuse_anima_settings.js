...
const TEXT = {
  en: {
    ...
    loraStrengthDragStepTip:
      "Amount added per horizontal drag pixel on LoRA preset strength values. Lower values make dragging finer. 0.05 matches the previous behavior.",
  ...
  ko: {
    ...
    loraStrengthDragStepTip:
      "LoRA 프리셋 강도 값을 좌우로 드래그할 때 픽셀당 더해지는 값입니다. 낮을수록 세밀하게 조절됩니다. 0.05는 이전 동작과 같습니다.",
