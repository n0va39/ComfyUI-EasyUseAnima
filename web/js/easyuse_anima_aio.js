...
const AIO_TOOLTIP_TEXT = {
  en: {
    ...
    "tip.safePagEnabled": "Applies built-in Easy Anima Safe PAG. No external Safe PAG pack or extra weights are required.",
  ...
  ko: {
    ...
    "tip.safePagEnabled": "내장 Easy Anima Safe PAG를 적용합니다. 외부 Safe PAG 팩이나 추가 모델 파일이 필요하지 않습니다.",
