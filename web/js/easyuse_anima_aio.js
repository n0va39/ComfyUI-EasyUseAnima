...
const AIO_TEXT = {
  en: {
    ...
    "dialog.save.subtitle": "EasyUse native output saves A1111 metadata and ComfyUI workflows in PNG, JPEG, and WebP.",
    ...
    "section.imageSaverFiles": "Native Image Files",
    "section.imageSaverMetadata": "Native Image Metadata",
    ...
    "field.negpip": "NegPip",
    "field.daveStages": "DAVE stages",
    "field.daveFirstPass": "First pass",
    "field.daveHighres": "Highres",
    "field.daveDetailer": "Detailer",
    "field.daveUpscale": "Upscale (USDU)",
    ...
    "tip.additionalHashes": "Manual Civitai-compatible hashes. Supports Name:HASH, HASH:Weight, and Name:HASH:Weight.",
    "tip.hashBundles": "Reusable manual hash groups appended to native output metadata.",
    "tip.civitaiHashFetchers": "Queries the fixed Civitai API at queue time and appends model_name:AutoV3 to the native metadata.",
    ...
    "tip.resshiftStudent": "Select a local ResShift student. Installed default uses the matching x2/x4 file in models/resshift. Also install autoencoder_vq_f4.pth there. AiO does not download models.",
    "label.resshiftInstalledDefault": "Installed default student",
  ...
  ko: {
    ...
    "dialog.save.subtitle": "EasyUse 네이티브 출력은 PNG, JPEG, WebP에 A1111 메타데이터와 ComfyUI 워크플로우를 저장합니다.",
    ...
    "section.imageSaverFiles": "네이티브 이미지 파일",
    "section.imageSaverMetadata": "네이티브 이미지 메타데이터",
    ...
    "field.negpip": "NegPip",
    "field.daveStages": "DAVE 적용 단계",
    "field.daveFirstPass": "1차 생성",
    "field.daveHighres": "Highres",
    "field.daveDetailer": "Detailer",
    "field.daveUpscale": "Upscale (USDU)",
    ...
    "tip.additionalHashes": "Civitai 호환 수동 해시입니다. Name:HASH, HASH:Weight, Name:HASH:Weight를 지원합니다.",
    "tip.hashBundles": "네이티브 출력 메타데이터에 추가할 재사용 가능한 수동 해시 묶음입니다.",
    "tip.civitaiHashFetchers": "큐 실행 시 고정된 Civitai API를 조회하고 model_name:AutoV3를 네이티브 메타데이터에 추가합니다.",
    ...
    "tip.resshiftStudent": "로컬 ResShift student를 선택합니다. 설치된 기본 모델은 models/resshift의 x2/x4 대응 파일을 사용합니다. 같은 폴더에 autoencoder_vq_f4.pth도 필요합니다. AiO는 모델을 다운로드하지 않습니다.",
    "label.resshiftInstalledDefault": "설치된 기본 student",
  ...
  ja: {
    ...
    "title.detailer": "DETAILER",
    "label.mode": "モード",
    "section.conditioning": "コンディショニング",
    "field.negpip": "NegPip",
    "label.seed": "シード",
    "label.steps": "ステップ",
    "label.cfg": "CFG",
    ...
    "label.enabled": "有効",
    "label.info": "詳細情報",
    "field.daveStages": "DAVE 適用 stage",
    "field.daveFirstPass": "First pass",
    "field.daveHighres": "Highres",
    "field.daveDetailer": "Detailer",
    "field.daveUpscale": "Upscale (USDU)",
    ...
    "tip.additionalHashes": "Civitai 互換の手動ハッシュです。Name:HASH、HASH:Weight、Name:HASH:Weight を使用できます。",
    "tip.hashBundles": "ネイティブ出力メタデータに追加する再利用可能な手動ハッシュ群です。",
    "tip.civitaiHashFetchers": "キュー実行時に固定 Civitai API を照会し、model_name:AutoV3 をネイティブメタデータに追加します。",
  ...
  zh: {
    ...
    "label.enabled": "启用",
    "label.info": "更多信息",
    "field.daveStages": "DAVE 应用阶段",
    "field.daveFirstPass": "第一次生成",
    "field.daveHighres": "Highres",
    "field.daveDetailer": "Detailer",
    "field.daveUpscale": "Upscale (USDU)",
    ...
    "tip.additionalHashes": "Civitai 兼容的手动哈希。支持 Name:HASH、HASH:Weight、Name:HASH:Weight。",
    "tip.hashBundles": "追加到原生输出元数据的可复用手动哈希组。",
    "tip.civitaiHashFetchers": "排队时查询固定的 Civitai API，并将 model_name:AutoV3 追加到原生元数据。",
...
const AIO_TOOLTIP_TEXT = {
  en: {
    ...
    "tip.negpipMode": "Off preserves current conditioning. On applies CLIPNegPip while keeping positive/negative conditioning and saved CFG. Turbo combines the negative prompt at × -1 and uses effective CFG 1.",
    ...
    "tip.daveStagePreset": "Choose whether DAVE runs only on the first pass, on every sampling stage, or on a custom set of stages.",
    "tip.daveStageFirstPass": "Apply DAVE to the first sampling pass.",
    ...
    "tip.saveBackend": "EasyUse native output writes A1111, workflow, and Civitai metadata. Comfy SaveImage uses ComfyUI's built-in PNG saver.",
    "tip.saveFilename": "Filename pattern for native output. Legacy tokens such as %time and %basemodelname remain supported.",
    "tip.savePath": "Output subfolder below the active ComfyUI output directory.",
    "tip.saveExtension": "Native output image format: PNG, JPEG, or WebP.",
    "tip.saveQuality": "Lossy JPEG/WebP quality from 1 to 100.",
    ...
    "tip.saveCounter": "Counter value available to the native filename template.",
    "tip.saveTimeFormat": "strftime-style time format used by native filename tokens.",
    "tip.saveClipSkip": "Clip skip value written to A1111 metadata.",
    ...
    "tip.savePromptMetadata": "Writes positive and negative text to A1111 metadata. Disable to omit prompt text.",
    "tip.saveCivitaiData": "Off by default. Enable to use the fixed Civitai HTTPS API for resource identifiers; local hashes are saved without it.",
    "tip.saveEasyRemix": "Removes LoRA tags and shortens embedding paths in the visible A1111 prompt while retaining hashes.",
    "tip.saveCustom": "Custom text appended to the A1111 parameter line.",
  ...
  ko: {
    ...
    "tip.negpipMode": "끄기는 기존 컨디셔닝을 유지합니다. 켜기는 positive/negative 컨디셔닝과 저장 CFG를 유지하며 CLIPNegPip을 적용합니다. Turbo는 negative prompt를 × -1로 결합하고 effective CFG 1을 사용합니다.",
    ...
    "tip.daveStagePreset": "DAVE를 1차 생성만, 모든 샘플링 단계, 또는 사용자 지정 단계에 적용할지 선택합니다.",
    "tip.daveStageFirstPass": "DAVE를 1차 샘플링에 적용합니다.",
    ...
    "tip.saveBackend": "EasyUse 네이티브 출력은 A1111, workflow, Civitai 메타데이터를 기록합니다. Comfy SaveImage는 ComfyUI 기본 PNG 저장을 사용합니다.",
    "tip.saveFilename": "네이티브 출력 파일명 패턴입니다. %time, %basemodelname 같은 기존 토큰도 계속 지원합니다.",
    "tip.savePath": "현재 ComfyUI output 디렉터리 아래의 출력 하위 폴더입니다.",
    "tip.saveExtension": "네이티브 출력 이미지 형식입니다: PNG, JPEG, WebP.",
    "tip.saveQuality": "손실 JPEG/WebP 품질 값입니다(1~100).",
    "tip.saveLosslessWebp": "WebP 출력 선택 시 lossless WebP로 저장합니다.",
    "tip.saveOptimizePng": "PNG 출력 선택 시 PNG 최적화를 실행합니다.",
    "tip.saveCounter": "네이티브 파일명 템플릿에서 사용할 counter 값입니다.",
    "tip.saveTimeFormat": "네이티브 파일명 토큰에 사용할 strftime 형식입니다.",
    "tip.saveClipSkip": "A1111 메타데이터에 기록할 clip skip 값입니다.",
    ...
    "tip.savePromptMetadata": "A1111 메타데이터에 positive/negative 프롬프트를 기록합니다. 끄면 프롬프트 텍스트를 제외합니다.",
    "tip.saveCivitaiData": "기본값은 꺼짐입니다. 켜면 고정된 Civitai HTTPS API로 리소스 식별자를 추가하며, 로컬 해시는 이 옵션 없이도 저장됩니다.",
    "tip.saveEasyRemix": "해시는 유지하면서 보이는 A1111 프롬프트의 LoRA 태그를 제거하고 embedding 경로를 줄입니다.",
    "tip.saveCustom": "A1111 파라미터 줄에 추가할 사용자 메타데이터입니다.",
  ...
  ja: {
    ...
    "tip.negpipMode": "オフは既存の conditioning を維持します。オンは positive/negative conditioning と保存 CFG を保ったまま CLIPNegPip を適用します。Turbo は negative prompt を × -1 で結合し、実行時 CFG 1 を使用します。",
    ...
    "tip.daveStagePreset": "DAVE を first pass のみ、すべての sampling stage、またはカスタム stage に適用します。",
    "tip.daveStageFirstPass": "DAVE を最初の sampling pass に適用します。",
    ...
    "tip.saveBackend": "EasyUse ネイティブ出力は A1111、workflow、Civitai metadata を保存します。Comfy SaveImage は標準 PNG 保存を使います。",
    "tip.saveFilename": "ネイティブ出力の filename pattern です。%time や %basemodelname など従来の token も使えます。",
    "tip.savePath": "現在の ComfyUI output directory 配下の出力 subfolder です。",
    "tip.saveExtension": "ネイティブ出力形式です: PNG、JPEG、WebP。",
    "tip.saveQuality": "lossy JPEG/WebP の quality 値です（1〜100）。",
    "tip.saveLosslessWebp": "WebP 出力時に lossless WebP で保存します。",
    "tip.saveOptimizePng": "PNG 出力時に PNG optimization を実行します。",
    "tip.saveCounter": "ネイティブ filename template で使う counter 値です。",
    "tip.saveTimeFormat": "ネイティブ filename token に使う strftime 形式です。",
    "tip.saveClipSkip": "A1111 metadata に記録する clip skip 値です。",
    "tip.saveEmbedWorkflow": "保存画像に ComfyUI workflow を埋め込み、再読み込み可能にします。",
    "tip.saveWorkflowJson": "workflow JSON sidecar も保存します。",
    "tip.savePromptMetadata": "A1111 metadata に positive/negative prompt を記録します。無効にすると prompt text を除外します。",
    "tip.saveCivitaiData": "初期値はオフです。有効にすると固定 Civitai HTTPS API から resource identifier を追加します。local hash はこの設定なしでも保存されます。",
    "tip.saveEasyRemix": "hash を保持したまま、表示用 A1111 prompt から LoRA tag を除き embedding path を短縮します。",
    "tip.saveCustom": "A1111 parameter 行に追加する custom metadata です。",
  ...
  zh: {
    ...
    "tip.negpipMode": "关闭时保持现有 conditioning。开启时应用 CLIPNegPip，并保留 positive/negative conditioning 和已保存 CFG。Turbo 将 negative prompt 按 × -1 合并，并使用 effective CFG 1。",
    ...
    "tip.daveStagePreset": "选择 DAVE 仅用于第一次生成、所有采样阶段或自定义阶段。",
    "tip.daveStageFirstPass": "将 DAVE 应用于第一次采样。",
    ...
    "tip.saveBackend": "EasyUse 原生输出保存 A1111、workflow 和 Civitai 元数据。Comfy SaveImage 使用内置 PNG 保存。",
    "tip.saveFilename": "原生输出文件名 pattern。继续支持 %time、%basemodelname 等旧 token。",
    "tip.savePath": "当前 ComfyUI output 目录下的输出子文件夹。",
    "tip.saveExtension": "原生输出格式：PNG、JPEG、WebP。",
    "tip.saveQuality": "有损 JPEG/WebP 的 quality 值（1~100）。",
    "tip.saveLosslessWebp": "选择 WebP 输出时保存为 lossless WebP。",
    "tip.saveOptimizePng": "选择 PNG 输出时运行 PNG optimization。",
    "tip.saveCounter": "原生文件名模板使用的 counter 值。",
    "tip.saveTimeFormat": "原生文件名 token 使用的 strftime 格式。",
    "tip.saveClipSkip": "写入 A1111 元数据的 clip skip 值。",
    "tip.saveEmbedWorkflow": "将 ComfyUI workflow 嵌入保存图像，便于重新加载。",
    "tip.saveWorkflowJson": "同时保存 workflow JSON sidecar 文件。",
    "tip.savePromptMetadata": "将 positive/negative prompt 写入 A1111 元数据。关闭后不写入 prompt text。",
    "tip.saveCivitaiData": "默认关闭。启用后通过固定的 Civitai HTTPS API 添加资源标识；本地哈希无需启用此选项也会保存。",
    "tip.saveEasyRemix": "保留哈希，同时从可见的 A1111 prompt 中移除 LoRA tag 并缩短 embedding path。",
    "tip.saveCustom": "追加到 A1111 parameter 行的自定义元数据。",
...
const AIO_STATIC_TEXT_KEYS = {
  ...
  "EasyUse native output saves A1111 metadata and ComfyUI workflows in PNG, JPEG, and WebP.": "dialog.save.subtitle",
  ...
  "Installed default student": "label.resshiftInstalledDefault",
  ...
  "Native Image Files": "section.imageSaverFiles",
  "Native Image Metadata": "section.imageSaverMetadata",
...
const AIO_FIELD_LABEL_KEYS = {
  ...
  "Upscale (USDU)": "field.daveUpscale",
  "Mask": "field.mask",
