...
class PythonFileDispositionContractTests(unittest.TestCase):
    ...
    def test_repository_contract_passes_with_zero_unclassified_files(self):
        ...
        self.assertEqual(contract["expected_baseline_files"], 192)
        self.assertEqual(contract["expected_target_files"], 206)
        self.assertEqual(len(contract["entries"]), 192)
        self.assertEqual(len(contract["target_paths"]), 206)
