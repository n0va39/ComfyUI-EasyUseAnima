...
이 문서는 사용자용 노드 상세 설명의 진입점입니다. 전체 설치와 공통 설정은
상위 [README](../../README.ko.md)를 먼저 참고하세요.
...
| Anima Prompt Studio Advanced v2 | `EASYUSE_ANIMA_PROMPT_DATA` dict를 출력하는 v2 편집 노드 | [문서](anima-prompt-studio-advanced.ko.md) |
| EASYUSE_ANIMA_PROMPT_DATA | prompt data pass-through, override, 기존 호환 출력 펼치기 | [문서](anima-prompt-studio-advanced.ko.md) |
| Anima Prompt Data Conditioning | prompt data에서 conditioning, 모델 패치, latent image 생성 | [문서](anima-prompt-studio-advanced.ko.md) |
