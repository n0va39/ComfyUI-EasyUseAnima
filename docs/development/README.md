...
2. Active version plan, currently `docs/development/0.2.3.md`
3. Latest released baseline, currently `docs/development/0.2.2.md`
...
- Active next-version plan: `docs/development/0.2.3.md`
- Latest released baseline: `docs/development/0.2.2.md`
