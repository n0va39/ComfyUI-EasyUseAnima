...
| 16 | A169 stage pipeline series | A169-01 MERGED; A169-02 First pass INVENTORY in `aio-first-pass-stage.md` | Contract then Behavior | #169 | Typed config and mechanical AiO move |
