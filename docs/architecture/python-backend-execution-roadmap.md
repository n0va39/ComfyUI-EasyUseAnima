...
| 17 | A169 first-pass cache policy | A169-CACHE-01 through CACHE-05b MERGED; CACHE-06 4K/batch allocation and latency evidence INVENTORY | Contract then Behavior | #169 | Mechanical cache move and stable stage seam |
