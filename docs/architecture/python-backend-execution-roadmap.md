...
| 16 | A169 stage pipeline series | A169-01 through A169-06 MERGED; A169-07 Save/output INVENTORY in `aio-save-output-stage.md` | Contract then Behavior | #169 | Typed config and mechanical AiO move |
