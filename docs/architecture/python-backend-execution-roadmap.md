...
| 15 | S167 backend seed reservation series | S167-01 through S167-03c COMPLETE on `dev`; S167-03d Prompt Studio cutover Behavior VALIDATED | Contract then Move then Behavior | #167 | Canonical AiO/node seams |
...
are still scrubbed but cannot choose the next seed. AiO remains unchanged for
the separate S167-03e rollback unit.
