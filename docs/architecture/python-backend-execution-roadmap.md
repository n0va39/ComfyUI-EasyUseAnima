...
| 15 | S167 backend seed reservation series | S167-01/01a/01b complete; S167-02 implemented in PR #358 with final full pending | Contract then Move then Behavior | #167 | Canonical AiO/node seams |
...
PR #358 implements that service boundary and composes one process-lifetime
owner without adding production callers. S167-03 remains blocked until #358
passes its one official full gate and reaches `dev`.
