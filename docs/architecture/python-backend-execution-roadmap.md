...
| 18 | D-series canonical root consolidation | D-01 translation COMPLETE on `dev` in PR #381; D-08 filesystem INVENTORY; behavior prerequisite #163 complete | Move | #186 | Phase B exit; per-feature behavior stable |
