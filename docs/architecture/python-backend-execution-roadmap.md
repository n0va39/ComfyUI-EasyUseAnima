...
| 16 | A169 stage pipeline series | A169-01 through A169-07 MERGED; A169-08 lifecycle ownership INVENTORY in `aio-lifecycle-ownership.md` | Contract then Behavior | #169 | Typed config and mechanical AiO move |
