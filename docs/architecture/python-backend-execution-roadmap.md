...
| D - root consolidation | D-01 and D-08 complete; D-09 inventory in progress | Continue #186 feature by feature after the corresponding behavior contracts are stable |
...
| 18 | D-series canonical root consolidation | D-01 translation and D-08 filesystem COMPLETE on `dev`; D-09 settings INVENTORY; behavior prerequisite #163 complete | Move | #186 | Phase B exit; per-feature behavior stable |
